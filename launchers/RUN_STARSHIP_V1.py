...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║   🚀 STARSHIP GENERATOR V1 - LAUNCHER                                        ║
║      Classic Edition - Works 100% with Maya Primitives                       ║
║                                                                              ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║   INSTRUCTIONS:                                                              ║
...
try:
    ...
    if 'starship' in sys.modules:
        del sys.modules['starship']
    
    from starship import create_starship, create_fleet, show_ui
    
    print("\n" + "═"*60)
    print("🚀 STARSHIP GENERATOR V1 LOADED!")
    print("═"*60)
    print()
    print("QUICK START:")
